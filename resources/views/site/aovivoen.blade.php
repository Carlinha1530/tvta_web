...
@section('pagina_titulo', "Ao Vivo em Inglês")
@section('content')
    ...
    <div class="wrap_6 wrap_7">
        ...
        @if(!empty($aovivo->link_videoen) )
            <div id="video-container" class="streaming img " alt="Inscreva-se e fique por dentro de nossas transmssões" title="Imagem Alternativa Streaming">
                <iframe class="stream" src="{{ $aovivo->link_videoen }}" width="853" height="480" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen title="Streaming Ao Vivo"></iframe>
                {{--  <iframe width=“853" height=“480" src="https://www.youtube.com/embed/s5zcdFH0Eg4?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>  --}}
            </div><br><br>
        @else
