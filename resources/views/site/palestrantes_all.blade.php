...
@section('pagina_titulo', 'Palestrantes')

@section('content')
    <div class="wrap_6">
        <div class="row">
            <div class="col-md-12 wow fadeInLeft">
                <h3 class="header_1 text_6 color_1 bg_3">Palestrantes</h3>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-3 wow fadeInRight" data-wow-delay=".2s">
                    <div class="box_1">
                        @if(!empty($palestrante->imagem))
                            <a href="{{ Route('site.palestrante', $palestrante->slug) }}" data-toggle="tooltip" title="{{ $palestrante->nome }}" data-placement="bottom">
                        ...
                        <div class="caption">
                            <h5 class="text_4 color_3">
                            	<a href="{{ Route('site.palestrante', $palestrante->slug) }}" data-toggle="tooltip" title="{{ $palestrante->nome }}" data-placement="right">
                            ...
                            <p class="text_9 color_4">
                                ...
                                @endif
                                {{-- <a href="{{ Route('site.palestrante', [$palestrante->id]) }}"><strong style="font-weight: bold;color: #4080ff;">Ver mais</strong></a> --}}
                            </p>
                        </div>
                        <a class="btn_1 text_7 color_1 bg_3" href="{{ Route('site.palestrante', $palestrante->slug) }}">Ver mais </a><br><br><br>
                    </div>
                </div>
                @endforeach
            </div>
