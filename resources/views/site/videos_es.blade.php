...
@section('pagina_titulo', 'Vídeos em Espanhol')

@section('content')
    <div class="wrap_6">
        <div class="row">
            <div class="col-md-12 wow fadeInLeft">
                <h3 class="header_1 text_6 color_1 bg_3">Vídeos em Espanhol</h3>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-3 wow fadeInRight" data-wow-delay=".2s">
                    <div class="ta-panel ta-panel-nofooter" style="background-color: #fff;margin-bottom: 10%;">
                        ...
                        <div class="panel-footer" style="background-color: #fff;">
                            <h4><a class="text_12_1 color_3" href="{{ Route('site.video_es', $video->slug) }}" data-toggle="tooltip" title="{{ $video->nome }}" data-placement="bottom">{{ str_limit($video->nome, 25) }}</a></h4>
                        </div>
