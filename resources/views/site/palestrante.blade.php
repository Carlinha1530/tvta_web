...
@section('content')
    @if($palestrante->publicar=='sim' && $palestrante->tipo=='palestrante')
    	<div class="wrap_6">
            <div class="row">
                <div class="col-md-12 wow fadeInLeft">
                    <h3 class="header_1 text_6 color_1 bg_3">
                        <a href="{{ Route('site.palestrantes_all')}}" data-toggle="tooltip" title="Ir a página de paletsrantes" data-placement="top">Palestrantes</a> / 
                                ...
                                @else 
                                    <div class="col-md-12 wow fadeInLeft">
                                        ...
                                        <h5 class="text_4 color_3">
                                            Desculpe, nenhum vídeo encontrado para esse palestrante.
                                            <a href="{{ Route('site.palestrantes_all')}}" title="Veja Outros vídeos"><strong style="font-weight: bold;color: #ec1019;"> Click aqui para escolher outro palestrante.</strong></a> 
                                        </h5><br><br>
                                    </div>
                                @endif
                            </div>
    ...
    @else
        <br>
        <h5 class="text_4 color_3">
            Desculpe, o palestrante "{{$palestrante->nome}}" não está disponivel. {{-- Faça outra busca. --}}
            <a href="{{ Route('site.palestrantes_all')}}"><strong style="font-weight: bold;color: #ec1019;"> Click aqui para ver outro palestrante.</strong></a> 
        </h5><br><br>
    @endif
@endsection