...
@section('content')
    @if($palestrante->publicar=='sim' && $palestrante->tipo=='programa')
        <div class="wrap_6">
            <div class="row">
                <div class="col-md-12 wow fadeInLeft">
                    <h3 class="header_1 text_6 color_1 bg_3">
                        <a href="{{ Route('site.programas_all')}}" data-toggle="tooltip" 
                        title="Ir a página de Programas" data-placement="top">Programas</a> / 
                                ...
                                @else 
                                    <div class="col-md-12 wow fadeInLeft">
                                        ...
                                        <h5 class="text_4 color_3">
                                            Desculpe, nenhum vídeo encontrado para esse programa.
                                            <a href="{{ Route('site.programas_all')}}"><strong style="font-weight: bold;color: #ec1019;"> Click aqui para escolher outro programa.</strong></a> 
                                        </h5><br><br>
                                    </div>
                                @endif
                            </div>
    ...
    @else
        <br>
        <h5 class="text_4 color_3">
            Desculpe, o programa "{{$palestrante->nome}}" não está disponivel. 
            <a href="{{ Route('site.programas_all')}}"><strong style="font-weight: bold;color: #ec1019;"> Click aqui para ver outro Programa.</strong></a> 
        </h5><br><br>
    @endif
@endsection