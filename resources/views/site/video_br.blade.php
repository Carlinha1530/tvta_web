...
@section('content')
    @if($videos->publicar=='sim')
    	<div class="wrap_6 wow fadeInLeft">
            <h3 class="header_1 text_6 color_1 bg_3">
                <a href="{{ Route('site.videos_br')}}" data-toggle="tooltip" title="Ir para a página de vídeos" data-placement="top">Vídeos</a> / 
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="wrap_4">
                            ...
                            <a href="https://twitter.com/share" class="twitter-share-button" data-url="{{ Route('site.video_br', $videos->slug) }}" data-count="horizontal" data-lang="pt" data-dnt="true">Tweetar</a>
                            <!-- compartilhar facebook -->
                            <div class="fb-share-button" data-href="{{ Route('site.video_br', $videos->slug) }}" data-layout="button" >Compartilhar</div>
                            <!-- curtir facebook -->
                            <div class="fb-like" data-href="{{ Route('site.video_br', $videos->slug) }}" data-layout="button" data-action="like" data-size="small" data-show-faces="true" >Curtir</div><br><br>
                        </div>
                    </div>
                </div>
            </div>
    ...
    @else
        ...
        <h5 class="text_4 color_3">
            ...
            <a href="{{ Route('site.videos_br')}}"><strong style="font-weight: bold;color: #ec1019;"> Click aqui para ver outros vídeos.</strong></a> 
        </h5><br><br>
    @endif   
@endsection