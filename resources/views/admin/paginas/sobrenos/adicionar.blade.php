...
@section('content')
    <div class="container">
        <h3 class="center">Novo Sobre-Nós</h3>
        <div class="row">
            <nav>
                <div class="nav-wrapper blue darken-4">
                    <div class="col s12">
                        ...
                        <a class="breadcrumb">Nova Sobre-Nós</a>
                    </div>
                </div>
            </nav>
        </div><br>
        <div class="panel-body">
            <form action="{{ route('admin.paginas.sobrenos.salvar') }}" method="post" enctype="multipart/form-data" class="form_label">
