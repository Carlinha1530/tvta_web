...
@section('content')
    <div class="container">
        <h3 class="center">Editar Página</h3>
        <div class="row">
            <nav>
        ...
        <div class="panel-body">
            <form action="{{ route('admin.paginas.contatos.atualizar',$paginas->id) }}" method="post" enctype="multipart/form-data" class="form_label">
                {{csrf_field()}}
