...
class VideoController extends Controller
{
    ...
    public function adicionar()
    {
        ...
        return view('admin.videos.adicionar', compact('categorias','subcategorias','palestrantes','videos','series'));
    } 

    public function salvar(VideoRequest $request)
    {
        $videos = Video::create($request->all());
        // dd($videos->serie->nome);
        ...
        $videos->ordem_data = Carbon::now(); 
        // dd($videos->ordem_data);
    ...
    public function editar($id)
    {
        ...
        // $data = Carbon::createFromFormat('d/m/Y', $updated_at);
        // $videos->updated_at = Carbon::createFromFormat('Y-m-d H:i:s', $videos->updated_at);
        // $videos->updated_at = date('d/m/Y H:i:s', strtotime($videos->updated_at));
        return view('admin.videos.editar', compact('videos', 'series', 'categorias', 'subcategorias', 'palestrantes'));
    }

    public function atualizar(VideoRequest $request, $id)
    {
        $videos = Video::find($id);
        ...
        $videos->ordem_data = $request['ordem_data'];
